...
params:
  ...
  seqdata: "/blast-db/sars-cov-2-seq-data/2022-10-17_ncbi_sars-cov-2-sequences.fasta.gz"
...
seq_count_plot <- ggplot(data = seqs_by_country,
                         aes(x = count, y = reorder(country, count))) +
 geom_col() +
 scale_x_log10() +
...
ggsave(plot = seq_count_plot, filename = "output/figures/seq_count_plot.png")
